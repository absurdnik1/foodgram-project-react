...
from .models import (Favorite, Ingredient, AmountIngredientInRecipe,
...
class AmountIngredientInRecipeAdmin(admin.ModelAdmin):
...
class ShoppingCartAdmin(admin.ModelAdmin):
    """Кастомизация админ панели (управление списком покупок)."""
...
admin.site.register(AmountIngredientInRecipe, AmountIngredientInRecipeAdmin)
